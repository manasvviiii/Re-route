        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent className="flex flex-wrap gap-1">
              {domain.programs.map(p => <Badge key={p} variant="secondary">{p}</Badge>)}
            </CardContent>
          </Card>
        </div>
      </div>
            ...
            <CardContent>
              ...
              <div className="flex flex-wrap gap-3">
                {domain.skills.map((skill) => (
                  <Badge key={skill} className="text-base px-4 py-2 bg-gradient-to-r from-[#FFB347] to-[#FFDA63] text-accent-foreground">
                    {skill}
                  </Badge>
                ))}
              </div>
