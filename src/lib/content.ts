...
export const empowermentArticles = [
  {
    slug: 'rithuparna-ks-rolls-royce',
    title: 'From NEET Setback to Rolls-Royce: The Rithuparna KS Story',
    excerpt: 'After not cracking NEET UG, Rithuparna KS pursued a new path and landed a high-paying technical job at Rolls-Royce, showcasing the success possible in engineering.',
...
`
  ...
  {
    slug: 'anshika-jais-corporate-calling',
...
`
    ...
    {
    slug: 'ayushmann-khurrana-national-award',
...
export const engineeringDomains = [
  ...
  },
  {
  ...
  },
   {
    ...
    icon: 'Civil',
    description: 'Design, build, and maintain the foundation for our modern society – from roads and bridges to water supply systems and public infrastructure.',
    skills: ['Structural Analysis', 'AutoCAD', 'Geotechnical Engineering', 'Project Management', 'Surveying'],
    programs: ['B.Tech in Civil Engineering'],
    jobOutlook: {
      title: 'Essential & Enduring',
      details: 'Consistent demand fueled by urbanization and infrastructure renewal projects. Critical for societal development.',
    },
    salary: '₹4 - 10 LPA (Fresher to Mid-level)',
    heroImage: PlaceHolderImages.find((img) => img.id === 'domain-detail-hero'),
  },
   {
    ...
    icon: 'Aeronautical',
    description: 'Design, develop, and test aircraft and spacecraft. This field deals with aerodynamics, propulsion, and navigation systems to conquer the skies and beyond.',
    skills: ['Aerodynamics', 'Propulsion Systems', 'Flight Mechanics', 'CATIA/ANSYS', 'Aircraft Structures'],
    programs: ['B.Tech in Aeronautical/Aerospace Engineering'],
    jobOutlook: {
      title: 'Innovative & Specialized',
      details: 'Opportunities in defense, space exploration (ISRO), and commercial aviation. A field for high-flyers.',
    },
    salary: '₹6 - 15 LPA (Fresher to Mid-level)',
    heroImage: PlaceHolderImages.find((img) => img.id === 'domain-detail-hero'),
  },
...
export const domainMatrix: Record<string, number[]> = {
    ...
    'Aeronautical Engineering':    [5, 4, 7, 1, 4, 4, 2, 1, 1, 7, 3, 3, 2, 4, 7, 5, 3, 4, 7, 2],
    'Civil Engineering':        [2, 1, 4, 3, 3, 7, 4, 7, 1, 1, 1, 7, 7, 4, 3, 1, 2, 1, 2, 5],
...
export const domainDescriptions: Record<string, string> = {
    ...
    'Aeronautical Engineering':      "Focus: Design and analysis of aircraft/spacecraft, fluid dynamics, and propulsion systems. *Core Skills: Advanced Physics, Thermodynamics, High Precision Design.* Path: Aircraft Designer, Propulsion Specialist, Stress Analyst.",
    'Civil Engineering':          "Focus: Design and construction of public infrastructure, urban planning, and environmental structures. *Core Skills: Structural Integrity, Fieldwork, Societal Impact.* Path: Structural Engineer, Urban Planner, Construction Manager.",
